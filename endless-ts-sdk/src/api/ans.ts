...
export class ANS {
  ...
  async getOwnerAddress(args: { name: string }): Promise<AccountAddress | undefined> {
    return getOwnerAddress({ endlessConfig: this.config, ...args });
  }
  ...
  async getExpiration(args: { name: string }): Promise<number | undefined> {
    return getExpiration({ endlessConfig: this.config, ...args });
  }
  ...
  async getTargetAddress(args: { name: string }): Promise<AccountAddress | undefined> {
    return getTargetAddress({ endlessConfig: this.config, ...args });
  }
  ...
  async setTargetAddress(args: {
    ...
    return setTargetAddress({ endlessConfig: this.config, ...args });
  }
  ...
  async getPrimaryName(args: { address: AccountAddressInput }): Promise<string | undefined> {
    return getPrimaryName({ endlessConfig: this.config, ...args });
  }
  ...
  async setPrimaryName(args: {
    ...
    return setPrimaryName({ endlessConfig: this.config, ...args });
  }
   ...
   * @returns SimpleTransaction
   */
  async registerName(args: Omit<RegisterNameParameters, "endlessConfig">): Promise<SimpleTransaction> {
    return registerName({ endlessConfig: this.config, ...args });
  }
  ...
  async renewDomain(args: {
    ...
    return renewDomain({ endlessConfig: this.config, ...args });
  }
  ...
  async getName(args: { name: string }): Promise<GetANSNameResponse[0] | undefined> {
    return getName({ endlessConfig: this.config, ...args });
  }
  ...
  async getAccountNames(args: GetAccountNamesArgs): Promise<GetANSNameResponse> {
    return getAccountNames({ endlessConfig: this.config, ...args });
  }
  ...
  async getAccountDomains(args: GetAccountDomainsArgs): Promise<GetANSNameResponse> {
    return getAccountDomains({ endlessConfig: this.config, ...args });
  }
  ...
  async getAccountSubdomains(args: GetAccountSubdomainsArgs): Promise<GetANSNameResponse> {
    return getAccountSubdomains({ endlessConfig: this.config, ...args });
  }
  ...
  async getDomainSubdomains(args: GetDomainSubdomainsArgs): Promise<GetANSNameResponse> {
    return getDomainSubdomains({ endlessConfig: this.config, ...args });
  }
}
