...
export async function fetchFunctionAbi(
  ...
  const module = await getModule({ endlessConfig, accountAddress: moduleAddress, moduleName });
...
export async function fetchEntryFunctionAbi(
  ...
  const functionAbi = await fetchFunctionAbi(moduleAddress, moduleName, functionName, endlessConfig);
