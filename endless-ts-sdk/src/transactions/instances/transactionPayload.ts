...
export abstract class TransactionPayload extends Serializable {
  ...
  static deserialize(deserializer: Deserializer): TransactionPayload {
    ...
    switch (index) {
      ...
      case TransactionPayloadVariants.SafeScript:
        return TransactionPayloadScript.loadWithChecksum(deserializer);
      case TransactionPayloadVariants.SafeEntryFunction:
        return TransactionPayloadEntryFunction.loadWithChecksum(deserializer);
      default:
...
export class TransactionPayloadScript extends TransactionPayload {
  ...
  public paymentChecksum?: Uint8Array;
  ...
  serialize(serializer: Serializer): void {
    if (this.paymentChecksum) {
      serializer.serializeU32AsUleb128(TransactionPayloadVariants.SafeScript);
      this.script.serialize(serializer);
      serializer.serializeFixedBytes(this.paymentChecksum);
      return;
    }
  ...
  static loadWithChecksum(deserializer: Deserializer): TransactionPayloadScript {
    const script = Script.deserialize(deserializer);
    const checksum = deserializer.deserializeFixedBytes(32);
    const payload = new TransactionPayloadScript(script);
    payload.paymentChecksum = checksum;
    return payload;
  }
}
...
export class TransactionPayloadEntryFunction extends TransactionPayload {
  ...
  serialize(serializer: Serializer): void {
    if (this.paymentChecksum) {
      serializer.serializeU32AsUleb128(TransactionPayloadVariants.SafeEntryFunction);
