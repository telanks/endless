...
import {
  ...
  GetAccountsCoinBalanceData,
  GetCreatedCoinDataQuery
...
export type GetAccountCoinsDataResponse = GetAccountCoinsDataQuery;
export type GetCoinDataResponse = GetAccountCoinData["metadata"];
export type GetCreatedCoinDataResponse = GetCreatedCoinDataQuery;
...
export type GetANSNameResponse = GetNamesQuery["current_endless_names"];

export type GetAccountsCoinBalanceResponse = GetAccountsCoinBalanceData[]
