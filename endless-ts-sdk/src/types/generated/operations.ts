...
export type GetAccountCoinData = {
  balance: string;
  frozen: boolean;
  metadata: {
    id: string;
...
export type GetCreatedCoinDataQuery = {
...
export type GetNamesQueryVariables = Types.Exact<{
  offset?: Types.InputMaybe<Types.Scalars["Int"]["input"]>;
  limit?: Types.InputMaybe<Types.Scalars["Int"]["input"]>;
  where_condition?: Types.InputMaybe<Types.CurrentEndlessNamesBoolExp>;
  order_by?: Types.InputMaybe<Array<Types.CurrentEndlessNamesOrderBy> | Types.CurrentEndlessNamesOrderBy>;
}>;
...
export type GetAccountsCoinBalanceData = {
  address: string;
  balance: string;
  frozen: boolean;
}
